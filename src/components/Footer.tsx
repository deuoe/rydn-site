...
export default function Footer() {
  return (
    <footer className="mt-24 bg-gradient-to-br from-slate-50 via-white to-sky-50/40 border-t border-slate-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5">
            ...
            >
              <label htmlFor="newsletter" className="text-sm font-semibold text-slate-900">
                Stay in the loop
              </label>
              ...
              <div className="mt-3 flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-full border border-slate-300 bg-white px-4 py-2.5 text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
                />
                <button
                  type="submit"
                  className="inline-flex items-center justify-center rounded-full bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-sky-600"
                >
                  Subscribe
                </button>
              </div>
          ...
          {/* About */}
          <div className="lg:col-span-2">
            <h2 className="text-sm font-bold uppercase tracking-wider text-slate-900">Organization</h2>
            <ul className="mt-4 space-y-3 text-slate-600">
              <li><Link to="/about-us" className="hover:text-sky-700 transition">About Us</Link></li>
              <li><Link to="/our-team" className="hover:text-sky-700 transition">Our Team</Link></li>
              <li><Link to="/governance" className="hover:text-sky-700 transition">Governance</Link></li>
              <li><Link to="/press" className="hover:text-sky-700 transition">Press & Media</Link></li>
              <li><Link to="/donation" className="hover:text-sky-700 transition">Support Us</Link></li>
              <li><Link to="/contact-us" className="hover:text-sky-700 transition">Contact</Link></li>
            </ul>
          </div>

          {/* Contact */}
          <div className="lg:col-span-3">
            <h2 className="text-sm font-bold uppercase tracking-wider text-slate-900">Contact</h2>
            <ul className="mt-4 space-y-3 text-slate-600">
              <li className="flex items-start gap-3">
                <Mail size={16} className="mt-1 text-sky-600 shrink-0" />
                <a href="mailto:info@rydn.ca" className="hover:text-sky-700 transition">info@rydn.ca</a>
              </li>
              <li className="flex items-start gap-3">
                <Phone size={16} className="mt-1 text-sky-600 shrink-0" />
                <a href="tel:+16474983938" className="hover:text-sky-700 transition">(647) 498-3938</a>
              </li>
              <li className="flex items-start gap-3">
            ...
            <div className="mt-6 flex gap-2">
              <a
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-300 bg-white text-slate-700 transition hover:bg-sky-600 hover:text-white hover:border-sky-600"
              >
        ...
        <div className="mt-8 border-t border-slate-200 pt-6 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="text-sm text-slate-500 flex gap-4 flex-wrap">
            ...
            <Link to="/terms-of-service" className="hover:text-slate-900 transition">Terms</Link>
            <span aria-hidden>·</span>
            <Link to="/contact-us" className="hover:text-slate-900 transition">Contact</Link>
          </div>
        </div>
      </div>
    </footer>
